...
description: "Configure the Sita MCP server in Roo Code for intelligent codebase Q&A"
icon: "rabbit"
---
...
<Step title="Click MCP Servers">Select "MCP Servers" from the menu.</Step>

<Step title="Edit Global MCPs">
...
- The `codebase-qna` tool will be available when using Roo Code's AI features
